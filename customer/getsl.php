...
$mysql = mysqli_query($conn, "SELECT id,noidung FROM nhucau WHERE noidung = '$dexuat_1'|| noidung ='$dexuat_2'|| noidung = '$dexuat_3' || noidung ='$dexuat_4' || noidung = '$dexuat_5' ");
...
for($i = 0 ;$i < $quantity_1;++$i){
   ...
   //  else{$dungluong_1 = 0;}
   else if($dungluong_array[$i] == '8'){
      $dungluong_2 = 8;
   }
   // else{$dexuat_2 = 0;}
   else if($dungluong_array[$i] == '12'){
      $dungluong_3 = 12;
   }
   // else{$dungluong_3 = 0;}
   else if($dungluong_array[$i] == '24'){
      $dungluong_4 = 24;
   }
   // else{$dungluong_4 = 0;}
   else if($dungluong_array[$i] == '32'){
      $dungluong_5 = 32;
   }
   // else{$dungluong_5 = 0;}
...
if(isset($img)){
   $g = "AND (idhdh = $lsp_1 OR idhdh = $lsp_2)";
}
else $g = "";
if(isset($hang)){
    $a = "AND (hang = '$iphone' OR hang = '$samsung' OR hang = '$oppo')";
}
else $a = "";
if(isset($img)){
    $b = "AND (idhdh = '$lsp_1' OR idhdh = '$lsp_2')";
}
else $b = "";
if(isset($dexuat)){
    $c = "AND (nhucau = '$dexuat_1' OR nhucau = '$dexuat_2' OR nhucau = '$dexuat_3' OR nhucau = '$dexuat_4' OR nhucau = '$dexuat_5')";
}
else $c = "";
if(isset($gia)){
...
if(isset($dungluong)){
    $e = "AND (dungluong = '$dungluong_1' OR dungluong = '$dungluong_2' OR dungluong = '$dungluong_3' OR dungluong = '$dungluong_4' OR dungluong = '$dungluong_5')";
}
else $e = "";
$s = "SELECT COUNT(tensp)AS count FROM sanpham WHERE 1 ";
$sql = $s.''.$a.''.$b.''.$c.''.$d.''.$e.''.$g.''.$h;
